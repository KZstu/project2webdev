    ...
    return(<>
      <div class='container-fluid'>
        <form class="row" style={{minHeight: '60vh'}} onSubmit={onSubmit} >
            ...
            {/*Repair Details*/}
            <div class="col-12 col-lg-4 p-4 m-0" style={{minHeight:'30vh', backgroundColor:'#D5F5E3'}}>
            ...
            <div class="col-12 col-lg-4 p-0 m-0">    
                ...
                <div class="p-4" style={{minHeight:'20vh', backgroundColor:'#EDBB99'}}>
                    <FormCost sharedPropBond={sharedBond} sharedPropWarranty={sharedWarranty} /> {/*Child2 (FormCost)*/}
                </div>              
            </div>  
